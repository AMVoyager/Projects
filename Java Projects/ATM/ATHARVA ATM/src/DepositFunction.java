...
public class DepositFunction extends LoginPage {
  ...
  public DepositFunction(HashMap<Double, Double> logininfoOriginal) throws IOException {

    super(logininfoOriginal);

    System.out.println("deposit Constructor 1" + logininfo);

    frame.setTitle("Deposit Function");
        ...
        for (i = 1; i <= sheet.getLastRowNum(); i++) {
          ...
          if (logininfo.containsKey(d)) {
            ...
            if (logininfo.get(d) == password1) {
              ...
              messageLabel.setText("Deposit successful. New balance is $" + cell4.getNumericCellValue());
              // workbook1.close();
              // break;
            } else {
